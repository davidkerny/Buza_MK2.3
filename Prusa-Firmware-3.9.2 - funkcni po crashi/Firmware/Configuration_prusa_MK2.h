...
#define MESH_MIN_X 35       //mk3 24  mk2 35
#define MESH_MAX_X 238      //mk3 228 mk2 238     mk3 mezi body 204mm mk2 203mm
#define MESH_MIN_Y 6        //mk3 6   mk2 6       mk3 mezi body 204mm mk2 196mm
#define MESH_MAX_Y 202      //mk3 210 mk2 202    
...
#define MESH_HOME_Z_CALIB 0.2                //  tady bylo 0.2, pak zkouseno 1.0 a jen byla pomalejsi kalib
#define MESH_HOME_Z_SEARCH 5.0f           // Z lift for homing, mesh bed leveling etc.

#define X_PROBE_OFFSET_FROM_EXTRUDER 29.0     // Z probe to nozzle X offset: -left  +right   mk3 23   mk 23
#define Y_PROBE_OFFSET_FROM_EXTRUDER 1.5     // Z probe to nozzle Y offset: -front +behind   mk3 5    mk2 9  víc-sonda měří před bodem, míň - sonda je za bodem
