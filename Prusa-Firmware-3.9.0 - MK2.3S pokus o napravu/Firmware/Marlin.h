...
void manage_inactivity(bool ignore_stepper_queue=false);
  ...
  #define  enable_x() { WRITE(X_ENABLE_PIN, X_ENABLE_ON); WRITE(Y_ENABLE_PIN, Y_ENABLE_ON); }
  ...
  #else
    #define  enable_y() { WRITE(Y_ENABLE_PIN, Y_ENABLE_ON); WRITE(X_ENABLE_PIN, X_ENABLE_ON); }
